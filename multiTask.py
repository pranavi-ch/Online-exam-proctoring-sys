...
def openForm():
    ...
    def loginFieds():
        ...
        if login == "pranavi@21" and password == "2000":
    ...
    def showproctorConsole():
        ...
        faceRecogBtn.place(x=436, y=350)
    ...
    faceRecogBtn = Button(base, text="Face Recognition Status", height=2, width=20, font=BtnFont)
    ...
    def changColorAd():
        ...
        while(True):
            if color_ad == 1:
                ...
                faceRecogBtn.configure(bg=None)
                ...
                faceRecogBtn.configure(bg="#7FFF00")
